...
# Set up virtual environment and link your opencv installation
venv=.venv3
...
then
  ...
  # Optionally update all packages to their latest version
  #pip3 install pur
  ...
  pverstring=$(ls ${venv}/lib/ | grep python3 | head -n 1)
